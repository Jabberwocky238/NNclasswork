...
if __name__ == '__main__':
    aaa = T2T_ViT(img_size=32, tokens_type='transformer', in_chans=3, num_classes=100, embed_dim=512, depth=6,
                 num_heads=8, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop_rate=0., attn_drop_rate=0.,
                 drop_path_rate=0., norm_layer=nn.LayerNorm, token_dim=64)

    from torchsummary import summary
    summary(aaa, input_size=(3, 32, 32), batch_size=16, device='cpu')